...
description: 'Phase 2: Interactive product specification creation. Asks detailed questions
    ...
    metrics.md, and design-system-grounded clickable mockups with a component map. All
    documents are cross-linked via product-spec/README.md index. Use with: "create product
    spec", "/speckit.product-forge.product-spec"'
---
...
Ask (structured): _"How many distinct user journeys does this feature have?
(best estimate)"_ → store as `JOURNEY_COUNT`.
...
Ask (structured): _"How many mockup screens?"_ → store `MOCKUP_SCREEN_COUNT`.
