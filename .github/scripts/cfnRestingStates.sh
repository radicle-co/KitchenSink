...
# enumerated eleven states while `sandboxReap.yml` and `sandboxReconcile.yml` enumerated six. The five
...
#
# ⚠️ Deliberately NOT in `prScope.sh`. That file's contract is a pure scope MATCHER — "does this name belong
