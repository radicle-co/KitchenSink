...
**Git Tag**: (not specified) (commit b80b237)
**Date**: 2026-04-23
**Regulatory Context**: (not specified)

3 requirements traced across 4 traceability matrices.
12 test scenarios: 11 passed, 1 failed, 0 skipped, 0 untested.
1 hazards identified; 1 mitigated.
1 anomalies detected: 0 waived, 1 blocking.
...
|----------|------|---------|---------------|--------|
| Requirements | requirements.md | b80b237 | 2026-04-23 | Present |
...
| Hazard Analysis | hazard-analysis.md | b80b237 | 2026-04-23 | Present |
| Traceability Matrix | traceability-matrix.md | b80b237 | 2026-04-23 | Present |
...
All 1 hazards mitigated.

## 6. Known Anomalies

| ID | Type | Matrix | Disposition | Waiver |
|----|------|--------|-------------|--------|
| SCN-002-A1 | Failed Test | Matrix A | BLOCKING | — |
...
| Release Tag | (not specified) | Git SHA: b80b237 | 2026-04-23 |
