...
- Date: 2026-07-01
- Deciders: platform
- Related: [0002](0002-vpc-consolidation-and-cidr-scheme.md), [0003](0003-shared-alb-per-stage.md), [0005](0005-environment-tagging-and-pr-cleanup.md), [0039](0039-database-role-split.md) — supersedes this ADR's per-PR database ownership and drop-door clauses
...
`.github/scripts/teardownSandboxPr.sh`. The reason is the weakness ADR-0005's residue list named: a door
