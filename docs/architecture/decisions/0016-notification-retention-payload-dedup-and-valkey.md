...
> ⚠️ **NOTHING IN THIS SECTION IS BUILT.** It is a decision, not a description of running code.
...
**Known-incomplete work — this ADR describes a decision, not a shipped state.**
...
- **No notification service exists.** `packages/services/notification-service`,
  ...
  So is the durability bullet below — no ElastiCache
