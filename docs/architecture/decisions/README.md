...
| [0022](0022-in-stack-migration-trigger.md)                                | The schema migration runs INSIDE the deploy, ordered by a Trigger in every stack that touches the database                                                | Superseded by 0035 |
...
| [0035](0035-schema-stacks-decoupled-from-service-deploys.md)              | Each database's schema is a stack of its own, deployed and migrated ahead of everything that reads it                                                     | Accepted           |
| [0036](0036-preview-services-deploy-in-parallel.md)                       | A preview's services deploy in parallel, and a join asserts the ecosystem                                                                                 | Accepted           |
| [0037](0037-authored-foods-are-author-only.md)                            | Authored foods are author-only, and promotion is removed                                                                                                  | Accepted           |
| [0038](0038-authored-food-withdrawal.md)                                  | An authored food is withdrawn, not deleted, and recipe reads that live                                                                                    | Accepted           |
| [0039](0039-database-role-split.md)                                       | Each database has an owner, a migrator and a service role; nothing a service runs connects as the master                                                  | Accepted           |
| [0040](0040-test-principals-containment-and-purge.md)                     | Test principals: a signed marker, containment on production, and a repeatable self-purge                                                                  | Accepted           |
| [0041](0041-queue-work-guarantees.md)                                     | Queued work is claimed, owned by a row, and watched by something that cannot write                                                                        | Accepted           |
| [0042](0042-log-drain-coverage.md)                                        | Every runtime's logs reach Sentry, and a dead drain is not silent                                                                                         | Accepted           |
| [0043](0043-application-log-routing.md)                                   | One rule for where a log line goes, and a line never goes nowhere                                                                                         | Accepted           |
| [0044](0044-copy-forward-dedup-before-enqueue.md)                         | A line already answered is copied forward, not queued again                                                                                               | Accepted           |
