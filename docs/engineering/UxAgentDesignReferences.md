...
`AgentDesignReferences.md` §2 names for template-generated breadth. Backups were taken to the
...
- ⚠️ **One dangling reference was left deliberately.**
  `docs/reviews/2026-08-14-pr91-findings/10ImportUx.md` still names `iad-1`, `dsl-1`, `ux-eng-1` and
