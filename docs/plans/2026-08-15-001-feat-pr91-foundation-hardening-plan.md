...
evidence: docs/reviews/2026-08-14-pr91-findings/00Index.md (203 findings, 31 reports)
...
| **U1**      | ✅ DONE                        | `7775e228` | `docs/reviews/2026-08-16/u1ErasureDiagnosis.md`                     |
...
- The table name matches the `prScope.sh` delimiter rule (pr-1 must not match pr-15)
...
**Files** `docs/reviews/2026-08-14-pr91-findings/00Index.md`, plus the files each fix touches
...
- Origin: `docs/brainstorms/2026-08-15-pr91-foundation-requirements.md`
- Findings: `docs/reviews/2026-08-14-pr91-findings/00Index.md` (203, 31 reports)
