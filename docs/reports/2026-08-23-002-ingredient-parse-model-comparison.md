...
## 13. The rescue carries the AMOUNT — §12.7's first open item, closed the same day (2026-08-26)
...
### 13.1 The ruling (owner, 2026-08-26)
...
### 13.2 ⚠️ A DIFFERENT POPULATION FROM §12.1 — read the denominator before comparing
...
| neither reading contains the other       |   4 | 2 are §13.4's guard; 2 are garbled prose                   |
...
### 13.3 The four fraction lines, verbatim
...
### 13.4 ⛔ The one narrowing — an ABSENT LLM amount is silence, not a reading
...
### 13.6 ⚠️ The census and the merge — and the 8 lines where they diverge
...
`crfSizeField`), and the merge agrees with all but §13.4's 2 guard lines — which the census's granularity
...
### 13.7 ⛔ What is NOT closed by this
