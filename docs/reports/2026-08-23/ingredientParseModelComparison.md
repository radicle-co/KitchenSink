...
**Prior report:** [`2026-08-23/verificationBakeOff.md`](./verificationBakeOff.md). ⛔ **None of its numbers carry over.**
...
### 17.1 The defect, and why it was not "just a harness wart"
...
### 17.2 The ruling — the measure states MULTIPLE AMOUNTS, and the first of them stated no unit
...
### 17.3 ⛔ Every figure that moves — before and after, over the same 1,975 replayed trials
...
### 17.4 §14.6's 8 lines — 7 close, and the 8th was never this defect
...
verdict's _name_ rests on a token that is not a unit either. That is the residual §17.2 declines to take, and
it is why the connective is pinned rather than left undocumented.

### 17.5 ⛔ What is NOT re-measured here, and what is OWED
...
- ⛔ **§15's three-arm figures are NOT re-derived.** Those trial files were scratch artifacts and are gone;
  ...
  **shape** tables (if anyone recomputes them) will move the way §17.3's do. **Owed, and unpaid.**
