...
**Built on, not repeating**: `11Adversarial004011Split.md`, `12AdversarialStatusShells.md`,
`13AdversarialTopology.md`, `14AdversarialPremises.md`, `15AdversarialFoodRecipeModel.md`.
