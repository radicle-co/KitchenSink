...
| Commit     | Unit                                                                   |
| ---------- | ---------------------------------------------------------------------- |
| `371b2d30` | `cfnExport.sh` — a failed lookup is not an absent export               |
...
| --- | ----------------------- | --------------------------------- | ------------------ |
| 1   | `PRRT_kwDOR7sDRs6XhHcI` | `.github/scripts/cfnExport.sh:65` | **fixed**          |
| 2   | `PRRT_kwDOR7sDRs6Xbohn` | `.github/scripts/cfnExport.sh:87` | **fixed**          |
...
## 1. `cfnExport.sh:65` — the CLI failure is swallowed by the pipeline (`PRRT_kwDOR7sDRs6XhHcI`)
...
## 2. `cfnExport.sh:87` — `--optional` swallows everything (`PRRT_kwDOR7sDRs6Xbohn`)
