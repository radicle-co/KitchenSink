...
export interface RecipeFormMessages {
     ...
     * it"; this means "we had it and it was taken away". The line keeps its own name and amount.
     *
     * ⛔ "Food removed", NOT "Ingredient removed" — the first draft said the latter and it is FALSE. The
     * ingredient was not removed; it is right there with its name, quantity and unit intact. That is the
