 ...
 *
 * ⛔ WHY THIS EXISTS. A queue reading the per-file outcome off a FLAG EDGE — watching `uploader.uploading`
 * fall, then consulting `uploader.errorMessage` — breaks when status propagates asynchronously (as in a
 * react-query mutation), marking a photo `ok` that never uploaded. A resolved value cannot have an edge.
 *
