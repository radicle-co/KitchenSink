 ...
 *
 * `RecipeNutritionSlot` is unit-tested on its own; this file proves the surfaces that paint recipe cards actually
 * MOUNT it, in the card's meta row, from ONE shared batch promise:
 *
 *   - `RecipeListResults`       — `/[locale]/recipes`
...
import { RecipeListResults } from '../../list/RecipeListResults.js';
...
const SURFACES: readonly (readonly [string, (render: RenderRecipeNutrition) => ReactElement])[] = [
    ...
    [
        'RecipeDiscoveryResults (/discover)',
        (renderNutrition) => (
    ...
    [
        'RecipeBrowseRailResults (a /discover rail)',
        (renderNutrition) => (
