...
/**
 * ⛔ THE OMITTED RECIPE — the fourth case, which is not a state. (WEB; the native twin is
 * `omittedRecipe.native.test.tsx`, and the two are deliberately the same tests.)
 *
