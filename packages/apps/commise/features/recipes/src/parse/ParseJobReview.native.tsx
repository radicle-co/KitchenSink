...
const styles = StyleSheet.create({
    ...
    // ⛔ `white` (4.67:1), NOT `ocean-dark` (1.33:1 on this seafoam fill — an SC 1.4.3 failure). The web
    // half of this screen had the identical pairing; `colors.ts` already specifies white as the label for a
    // seafoam fill, and `buttonSurfaceClass` encodes it for every surface that uses the primitive.
    primaryLabel: { fontSize: nativeTokens.fontSize.bodySm, fontWeight: '600', color: palette.white },
    secondary: {
        minHeight: TOUCH_TARGET_DP,
        alignItems: 'center',
        justifyContent: 'center',
