...
/**
 * REWRITTEN for the 2026-08-26 owner ruling on device attribution (no `deviceLabel`). The banner has ONE
 * rendering, so the case below asserts the WHOLE string (never `toContain`),
