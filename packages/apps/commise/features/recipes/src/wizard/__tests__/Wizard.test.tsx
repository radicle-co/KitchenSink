...
describe('Wizard (web) — submitting busies the write actions', () => {
    it('busies the footer Publish primary while a save is in flight', () => {
    ...
    it('busies the action bar’s Save Draft while a save is in flight', async () => {
        const onSaveDraft = vi.fn();
        ...
        // The attribute is not enough on its own: assert the action cannot fire, which is the guarantee.
