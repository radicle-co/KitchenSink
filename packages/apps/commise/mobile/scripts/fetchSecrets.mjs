 ...
 *
 * Usage:
 *   node scripts/fetchSecrets.mjs [--stage=sandbox|dev|prod]
 *
 * Mirrors the web app's scripts/fetchSecrets.mjs. Requires AWS credentials with SecretsManager read
...
try {
    ...
    const lines = [
        '# Auto-generated by scripts/fetchSecrets.mjs',
