/**
 * @module home/homeContainer — the mobile Home appShell container (US-000 discovery layer).
 *
 ...
 *
 * Identical logic to the web host's `homeContainer` — the discovery layer is platform-neutral. In Home v1
 * only the recipe feature registers a widget. A feature package (005–009) lights up its widget by adding its
 ...
 *
 * @param container - The appShell container to register the recipe widget into.
 * @sideEffect Binds the recipe widget descriptor onto the supplied container.
 */
