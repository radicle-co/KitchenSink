...
// Identity endpoints (`/api/v1/users/me`, `/api/v1/accounts/me`) are served by the IDENTITY service, which is a
...
// `/api/v1/users/me` (read/update/delete) now goes through the typed `ProfileServiceClient` (DA10-c) —
...
export const getAccount = (getToken: GetToken) => apiRequest(getToken, '/api/v1/accounts/me');
