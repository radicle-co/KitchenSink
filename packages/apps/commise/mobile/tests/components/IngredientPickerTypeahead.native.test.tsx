 ...
 * IngredientPicker, driven through the REAL `useIngredientResolver` + `useSuggestIngredients` (mirrors the
 ...
 * the actual network-call boundary (`client.suggestIngredients`) the debounce/threshold gate protects.
 */
