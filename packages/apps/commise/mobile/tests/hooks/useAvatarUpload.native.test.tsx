...
describe('useAvatarUpload', () => {
    ...
    /**
     * ⛔ THE POINT OF FRONTING THIS WITH REACT-QUERY. The hook used to call `client.presignAvatar` from a bare
     * `useCallback`, so the only record that an upload was in flight was a `busy` boolean hand-rolled in
     * `AvatarField` — invisible to anything else, and impossible for another surface to observe. The upload is
     * now a mutation, so its status is part of the cache rather than a component's private state.
     *
