...
// The `KeyboardAvoidingView` wrapper is replaced with a labelled sentinel so a test can assert it is there.
// Same device `login.native.test.tsx` uses — jsdom renders neither, so the wrapper is otherwise invisible.
