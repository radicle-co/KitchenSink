 ...
 *
 * @pattern Composite boundary — Error Boundary ∘ Suspense: a render-time pending / failed / settled state machine,
 *     with TanStack's query-error reset composed into the error boundary's reset.
 */
