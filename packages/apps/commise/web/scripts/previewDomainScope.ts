...
// (ADR-0005: tagged with its persistent TIER, never `pr-{N}-…`). An over-broad host match would be far worse than the
 ...
 * (`.github/scripts/prScope.sh`), because a preview host is only ever the bare token; and being an
