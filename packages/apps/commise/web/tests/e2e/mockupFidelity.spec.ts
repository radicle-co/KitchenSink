...
const UNPAIRED: readonly UnpairedScreen[] = [
    { mockupFile: 'screenCooking.html', owningSpec: '008-cooking-mode' },
    { mockupFile: 'screenGrocery.html', owningSpec: '007-grocery-lists' },
    { mockupFile: 'screenMealplan.html', owningSpec: '006-meal-planning' },
    { mockupFile: 'screenNutrition.html', owningSpec: '009-nutrition-planning' },
];
...
const PAIRS: readonly PairSpec[] = [
    ...
    {
        slug: 'recipe-detail',
        mockupFile: 'screenRecipeDetail.html',
