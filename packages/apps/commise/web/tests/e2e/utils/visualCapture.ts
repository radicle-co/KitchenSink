 ...
 * `docs/mockups/screens/screenHome.html`, which loads no webfonts at all (its Google-Fonts `@import` sits
 ...
 *
 * Not arbitrary: `screenHome.html` depicts "Good afternoon, Chef!" over "Saturday, May 31, 2026", so this is
 ...
 * @param screenFile - A file name under `docs/mockups/screens`, e.g. `screenHome.html`.
