...
describe('the alarm feature flag — discovery is not vacuous', () => {
    ...
    it('finds the five alarm-owning stacks and all thirty-two alarms', () => {
        ...
        // system looks like, so nothing else could have reported it.
        expect(ALARM_SOURCES.flatMap(discoverAlarms).length).toBe(32);
