...
//
// `sandboxPreview.yml` keeps the one in its `gate` job — resolving the food origin is how the gate knows
...
const SOURCES = ['.github/workflows/sandboxPreview.yml', '.github/actions/infra-package/action.yml'].map((file) =>
