 ...
 *
 * `docs/architecture/2026-08-28/ingredientPipelineState.md` §1 said `verifyLine` and thirteen other
...
describe('the two halves agree on the tag key', () => {
    it('reads the key the stamp writes', () => {
        // ⛔ One knowledge, two modules — the WRITER (`@radicle-co/infra-shared/security`) and the READER (this
        ...
        // properties of the thing being guarded: `@radicle-co/infra-shared/security` exports BUILT JavaScript (see
        ...
        const stamp = readFileSync(path.join(repoRoot, 'shared/infra/src/security/commitProvenance.ts'), 'utf8');
