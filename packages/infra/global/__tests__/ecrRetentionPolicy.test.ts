/**
 * Repo-wide guard: the ECR retention policy (`.github/scripts/ecrLifecyclePolicy.json`).
 *
 ...
 * so previews outnumber releases by roughly 26:1. `ecrEnsureRepo.sh` re-applies this document on every
...
const POLICY_PATH = fileURLToPath(new URL('../../../../.github/scripts/ecrLifecyclePolicy.json', import.meta.url));
...
describe('ECR retention policy (.github/scripts/ecrLifecyclePolicy.json)', () => {
