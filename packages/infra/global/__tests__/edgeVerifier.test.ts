...
import { EDGE_JWT_KEY_GLOBAL, EDGE_SENTRY_DSN_GLOBAL } from '../src/edge-verifier/edgeBuildContract.js';
...
describe('prod-deploy.yml supplies the build-time key, in the right order', () => {
    ...
    function prodDeploySteps(): readonly {
        ...
        const doc = parse(
            ...
            jobs: Record<string, { steps?: { name?: string; run?: string; 'working-directory'?: string }[] }>;
        };
