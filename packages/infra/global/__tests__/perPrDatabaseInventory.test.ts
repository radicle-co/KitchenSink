 ...
 * and for half of them it never did: `teardownSandboxPr.sh` hardcoded food's migration-runner output, so
 ...
 *
 * `docs/runbooks/pg18Upgrade.md` §A4 asks an operator to run this exact query by hand before a major
