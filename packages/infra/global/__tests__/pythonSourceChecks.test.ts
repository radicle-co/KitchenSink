 ...
 * `recipes/ingredientCatalogBlend.yaml`, a committed Maestro flow executed by nothing for months. A
...
const DEV_REQUIREMENTS = 'requirementsDev.txt';
...
describe('every Python source this repository owns is linted, formatted and type-checked', () => {
    ...
    it('leaves the VENDORED Spec Kit extension alone — it arrives with its own toolchain', () => {
        ...
        // requirementsDev.txt. Re-linting a vendored tree to our house style is churn we would then own.
