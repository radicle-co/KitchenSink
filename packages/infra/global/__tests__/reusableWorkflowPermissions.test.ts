 ...
 * live in reusable workflows (`_ci.yml`, `sandboxPreview.yml`), and a reusable workflow cannot ask for a
 ...
 * `sandboxPreview.yml`'s `deploy-food` asked for `packages: read` while both of its callers
