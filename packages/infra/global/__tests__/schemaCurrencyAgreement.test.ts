 ...
 * whether a stale schema refuses a boot. `schemaCurrencyEnvironment` in `@radicle-co/infra-shared/security` is
...
import { schemaCurrencyEnvironment } from '@radicle-co/infra-shared/security';
