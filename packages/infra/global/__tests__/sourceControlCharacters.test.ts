 ...
 * hash into a latch key, and `food-service/src/sources/usda/bulk/usdaBulk.parser.ts` used raw `NUL`, `0x01` and
...
describe('no tracked source file contains a raw control character', () => {
    ...
    it('discovers the sources it is meant to constrain', () => {
        ...
        expect(files).toContain('packages/services/food-service/src/sources/usda/bulk/usdaBulk.parser.ts');
    });
