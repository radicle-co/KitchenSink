 ...
 *
 * The rules live in `./wire-contract-consumers.ts`; this file is what makes them binding, and it has two
 ...
 * allowlist that only fails on growth (`boundaries-ratchet` does exactly that, for reasons it documents). It
...
} from './wire-contract-consumers.js';
import type { ConsumerManifest, ConsumerPackage } from './wire-contract-consumers.js';
