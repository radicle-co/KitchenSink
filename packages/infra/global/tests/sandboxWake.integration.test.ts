/**
 * Integration suite for the sandbox DB wake gate's IMPURE half — `sandboxWake.sh ensure`
 * (`.github/scripts/sandboxWake.sh`). `__tests__/sandboxWake.test.ts` covers the pure predicates; this covers
...
describe('sandboxWake.sh ensure — the file exists', () => {
