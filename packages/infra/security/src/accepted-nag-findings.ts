...
// `__tests__/accepted-nag-findings.test.ts` → 'writes cdk_nag suppression metadata into the template').
 ...
 *
 * The key set is pinned by `__tests__/accepted-nag-findings.test.ts` → 'pins the exact set of accepted
