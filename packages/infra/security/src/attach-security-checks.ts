 ...
 * `packages/infra/global/__tests__/cdk-nag-attachment.test.ts` discovers every CDK app in the workspace
 ...
 * ADR-0008 makes the same no-prod-diff promise. `cdk-nag-template-parity.test.ts` asserts byte-identical
