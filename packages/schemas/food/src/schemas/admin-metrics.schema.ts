 ...
 */
// Source: packages/services/food-service/src/foods/admin/admin-metrics.schema.ts
 ...
 * (`admin-metrics.dao.ts`: `QueueDepthMetrics`, `BacklogMetrics`) and the service
 * (`admin-metrics.service.ts`: `SourceWindowMetrics`, `OperationalMetrics`), i.e. the wire contract of two
