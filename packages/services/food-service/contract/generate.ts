/**
 * ENTRY POINT for `npm run contract:generate --workspace=@kitchensink/food-service`.
 *
 ...
 *
 * @sideEffect Reads the service's schema sources and WRITES `packages/schemas/food` plus the service's own
 *             `CONTRACT_HASH` stamp.
 */
