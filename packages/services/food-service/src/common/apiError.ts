...
export const FOOD_ERROR_STATUS: Readonly<Record<FoodErrorCode, number>> = {
    ...
    DUPLICATE_AUTHORED_NAME: HttpStatus.CONFLICT,
    FOOD_REFERENCED: HttpStatus.CONFLICT,
    PROMOTION_NOT_FOUND: HttpStatus.NOT_FOUND,
    PROMOTION_NOT_ACTIONABLE: HttpStatus.CONFLICT,
    REFERENCE_CHECK_UNAVAILABLE: HttpStatus.SERVICE_UNAVAILABLE,
