...
/**
 * Fingerprint of the food (ingredient) service's authored wire contract (service-embedded copy).
 *
 ...
 */
export const CONTRACT_HASH = '001389e7952e0720d7781f3ea3fbc61f9e269280205e5975ade3f63236668a20';
