 ...
 * (`./contractHash.ts`) and the generated leaf package `@kitchensink/schema-food`. This module asserts, at boot, that the image
 ...
 * service; `@kitchensink/schema-food` is consumed for types), so nothing in-repo compares this value yet —
