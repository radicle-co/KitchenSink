/**
 * Named barrel for the source-agnostic `kitchensink_food` schema (feature 003). Re-exports the 5
...
export { foodStatusEnum, foodKindEnum, foodSourceEnum, foodFieldEnum, nutrientBasisEnum } from './food.js';
