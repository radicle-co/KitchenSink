 ...
 * FR-025a).
 *
 * `FOOD_UNRESOLVED_TTL_DAYS` is a LIVE knob — `infra/lib/FoodServiceStack.ts` stamps it into the
 ...
 *
 * The behavioural half of this lives in `tests/foodCandidates.dao.integration.test.ts` (a real 40-day-old
...
import { CandidateStore } from '../foodCandidates.dao.js';
