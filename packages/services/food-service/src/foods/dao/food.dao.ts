...
export class FoodDao {
     ...
     * a 100-id batch request — one per recipe-list render — costs ~500 round trips. No index is added;
     * `food_nutrients_food_id_idx` and `food_portions_food_id_idx` already serve the predicate.
     *
