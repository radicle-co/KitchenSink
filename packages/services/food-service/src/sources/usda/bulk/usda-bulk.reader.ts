 ...
 * `usda-bulk.parser.ts`. It reads LOCAL FILES ONLY — the bulk datasets are HTTP downloads, not API calls,
...
import { SilentWorkerLogger, type WorkerLogger } from '../../../worker/worker-logger.js';
import { UsdaBulkFormatError } from './usda-bulk.errors.js';
import { mapBulkFoodToCanonical } from './usda-bulk.parser.js';
import {
