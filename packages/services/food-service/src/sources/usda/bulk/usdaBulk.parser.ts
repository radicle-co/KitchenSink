...
import type { CanonicalCandidate, CanonicalNutrient, CanonicalPortion } from '../../foodSourceAdapter.js';
import { canonicalizeNutrientName, canonicalizeUnit } from '../usda.adapter.js';
import type { BulkFoodBundle, BulkLookups } from './usdaBulk.types.js';
 ...
 * `mergeSanitize.ts`'s `NON_NEGATIVE_DECIMAL` deliberately: a value this rejects would be dropped one
