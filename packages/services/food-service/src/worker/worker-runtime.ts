...
import type { FetchQueueDao } from '../foods/dao/fetch-queue.dao.js';
import { ConsoleWorkerLogger, type WorkerLogger } from './worker-logger.js';
import { acquireWorkerLock, releaseWorkerLock, type LockSession } from './worker-lock.js';
import type { FoodConsumerService } from './food-consumer.service.js';
