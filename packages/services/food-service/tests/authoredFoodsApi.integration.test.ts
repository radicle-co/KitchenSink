...
function principalFor(token: string): {
    ...
    switch (token) {
        case 'author':
            return { sub: 'user_author', userId: AUTHOR_ULID, scopes: [], permissions: [], testPrincipal: false };
        case 'stranger':
            return { sub: 'user_stranger', userId: STRANGER_ULID, scopes: [], permissions: [], testPrincipal: false };
        case 'm2m':
            return { sub: 'svc_import', scopes: [], permissions: [], testPrincipal: false };
        default:
