 ...
 * REAL Postgres, as `food_app` (ADR-0039), with the REAL `FoodAuthGuard` → `@kitchensink/clerk-verify`
...
describe.skipIf(!hasTestDatabase)('/api/v1/foods/* full-stack e2e (booted Nest + real Postgres + worker drain)', () => {
