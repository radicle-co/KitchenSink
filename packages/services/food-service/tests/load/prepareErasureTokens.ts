/**
 * Mint the EdDSA service-erasure tokens the k6 `serviceErasure.load.js` scenario presents (CR-002 / U4b).
 *
 * The food mirror of recipe-service's `prepareErasureTokens.ts`. WHY a prepare step (not minting inside
