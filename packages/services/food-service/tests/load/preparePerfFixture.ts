 ...
 *     `perfFixture.ts` alongside the TypeScript builders, and the two renderings are asserted to agree
 ...
 *            this script. Refuses any database not named in `perfFixture.ts`'s disposable allowlist.
 */
