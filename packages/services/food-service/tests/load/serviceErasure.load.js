...
// `prepareErasureTokens.ts` step and loaded here via `open()`. The food service under test MUST be booted
...
// Where prepareErasureTokens.ts wrote the pool. NOTE: k6's `open()` resolves relative to the SCRIPT, not
