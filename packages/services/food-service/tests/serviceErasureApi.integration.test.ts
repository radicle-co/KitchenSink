 ...
 * over the booted Nest app against a REAL Postgres, as `food_app` (ADR-0039). This is the food mirror of
 * recipe-service's U4a `serviceErasure.integration.test.ts`.
 *
...
import { generateServiceKeypair, signServiceErasureToken, type ServiceKeypair } from './support/serviceToken.js';

const OWNER = '01J9ZK8N7QF3B2X4M6T0V5C1AB';
const OTHER = '01J9ZK8N7QF3B2X4M6T0V5C1AD';

describe.skipIf(!hasTestDatabase)('POST /api/v1/internal/account/erasure (booted Nest + real Postgres)', () => {
