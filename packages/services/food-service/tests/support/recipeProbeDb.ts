 ...
 *
 * Under the role split (ADR-0039) the subject's pool is `food_app`, which holds DML and nothing else: it
 * cannot `CREATE DATABASE`, run DDL or `TRUNCATE` at all. So the probe is provisioned the way
