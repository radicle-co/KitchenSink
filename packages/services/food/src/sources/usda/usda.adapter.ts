/**
 * `UsdaSourceAdapter` (T-121 / MOD-008, ARCH-008) — wraps `@commise/clients-usda` to implement the
...
import type { UsdaApiClient, UsdaFoodDetail, UsdaNutrient } from '@commise/clients-usda';
import {
    isUsdaNotFoundError,
