/**
 * Full-stack e2e for `@commise/clients-food` (T-057) against the REAL booted food service.
 * Boots the same hermetic stack as `foods-api.e2e.test.ts` (real Nest app + real Postgres + the REAL
 * {@link FoodAuthGuard} → `@commise/shared-clerk-verify`, genuinely-signed RS256 tokens, the programmable
...
describe.skipIf(!DATABASE_URL)('@commise/clients-food against the booted food service (e2e)', () => {
