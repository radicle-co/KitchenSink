...
export class WebhooksStack extends Stack {
    ...
    public constructor(scope: Construct, id: string, props: WebhooksStackProps) {
        ...
        // deletion-worker (handlers/deletionWorker.ts): reads the DB creds (getDb) and drains the SQS
        ...
        // tombstone-sweep (handlers/tombstoneSweep.ts, CR-002 KTD-3): reads the DB creds (getDb) to scrub
        ...
        // erasure-reconciliation (handlers/erasureReconciliation.ts, CR-002 R7 completion contract): reads
