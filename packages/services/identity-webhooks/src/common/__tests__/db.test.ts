 ...
 *
 * ⛔ Who it connects as (the role split, `docs/plans/2026-09-11-database-role-split.md`): `getDb` logs in as
 * `identity_service` by RDS IAM — never the RDS master `identity_app`, a member of `rds_superuser` — and never
 * touches Secrets Manager. Asserted below, not assumed.
 */
