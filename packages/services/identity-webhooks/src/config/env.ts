 ...
 * (`@kitchensink/rds-iam-auth`), never via the RDS MASTER secret (`DB_SECRET_ARN`, `identity_app`, a member of
 * `rds_superuser`) — see `docs/plans/2026-09-11-database-role-split.md`.
