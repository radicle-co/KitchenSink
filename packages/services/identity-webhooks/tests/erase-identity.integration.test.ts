 ...
 * (`src/common/__tests__/erase-identity.test.ts`) drives a drizzle-shaped mock that discards `.where(...)`
...
import { eraseIdentityRow } from '../src/common/erase-identity.js';
import { hasDatabaseUrl, openIntegrationDb, resetIdentityRows } from './integration-db.js';
import { makeIdentityAccount, makeIdentityProfile, makeIdentityUser } from './__fixtures__/make-identity-user.js';
