        ...
        '/api/v1/users/me': {
            ...
            delete: {
                ...
                responses: {
                    ...
                    '403': {
                        description:
                            'The caller is a Clerk TEST PRINCIPAL and this deployment enforces test-principal ' +
                            'containment (`TEST_PRINCIPAL_CONTAINED`, ADR-0040). Nothing was changed: closing a ' +
                            'test-pool account would ban a shared pool member. Never returned for a real user.',
                        schema: 'ApiError',
                    },
                    '404': userNotFound,
                },
        ...
        '/health': {
            get: {
                ...
                description:
                    ...
                    '`@kitchensink/schema-identity` fingerprint differs WARNS and keeps working.',
                security: [],
