 ...
 *
 * ⛔ Never the RDS MASTER's password — `identity_app`, `rds_superuser` — behind a public ALB: a service
 * logged in as the master owns every table it writes. The role split
