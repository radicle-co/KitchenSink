 ...
 * elsewhere (`tests/auth.middleware.test.ts`, `tests/resolve-or-create.test.ts`) and are out of scope
...
function userFromScopesHeader(header: string | undefined): AuthorizerContext | undefined {
    ...
    return {
        userId: '01HZZE2EADMINAUTHZUSER0000' as AuthorizerContext['userId'],
...
describe('admin authZ — ScopesGuard e2e', () => {
    ...
    @Module({
        ...
        providers: [ScopesGuard, { provide: AdminService, useValue: adminServiceStub }],
    })
