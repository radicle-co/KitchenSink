...
//
// @loadTier substrate-bound — the 20,000-row table IS the fixture, and its prepare step DROPS the public schema —
//   unthinkable against shared identity
//
...
//
// The table size is a fixture, not an accident: `prepareDb.ts` seeds `IDENTITY_BULK_USERS` (default
...
//   k6 run -e IDENTITY_API_BASE_URL=http://localhost:3001 tests/load/adminUserSearch.load.js
//
