 ...
 * `docs/plans/2026-09-11-database-role-split.md`) — never as a superuser, and never as the RDS master. A
 * dedicated database, so the suite never touches the one the other suites share; named
