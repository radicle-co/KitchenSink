 ...
 *
 * Runs against a real Postgres named by DATABASE_ADMIN_URL — a THROWAWAY server: the fixture rebuilds the
 * schema between runs.
 */
/**
...
describe.skipIf(!hasTestDatabase)('lifecycle-aware provisioning — no resurrection (integration)', () => {
    let pool: pg.Pool;
