...
import { type AssetExpectation, assetViolations, handlerModuleOf } from '../lib/assetContents.js';
import {
    readEngineRecord,
    readHandlerImports,
    readNltkRecord,
...
import { ASSET_DIRECTORY, EXTENSION_TAG, HANDLER, NLTK_DATA_DIRECTORY, TARGET_CPU } from '../lib/packaging.js';
