...
describe.skipIf(!hasDatabaseUrl)('U14 — a verification verdict reaches the cook (integration)', () => {
     ...
     * `resolveLineStatus` — but only a LIVE `WITHDRAWN` status driven together with the privacy fact reaches
     * the presence-vs-viewer half of the composition. Inverting the two would leak, to a stranger, that a
     * private food they cannot see once existed and has been withdrawn.
     *
