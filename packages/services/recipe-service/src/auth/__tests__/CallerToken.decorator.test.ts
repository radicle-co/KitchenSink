 ...
 * here against a mock `ExecutionContext` — the same approach `currentPrincipal.decorator.test.ts` uses.
 */
import { describe, expect, it } from 'vitest';
import type { ExecutionContext } from '@nestjs/common';

import { CallerToken, revealCallerToken } from '../CallerToken.js';
import { resolveCallerBearerToken } from '../CallerToken.decorator.js';
