 ...
 * half of the guarantee lives in `ingredients/food-service-clients.factory.ts`, whose target origin comes
 ...
 *
 * **Restricted import.** Only `ingredients/food-service-clients.factory.ts` may import this: it is the sole
