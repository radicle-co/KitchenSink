 ...
 *    deletion-worker / reconciliation Lambdas (`erasure-fanout.ts`), which deploy independently.
...
import { ServiceErasureController } from '../../account/service-erasure.controller.js';
