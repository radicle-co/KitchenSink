...
export type FoodClientMocks = Record<string, Mock>;
...
export function makeFoodView(overrides: Partial<FoodResponse> = {}): FoodResponse {
    return {
        id: '01J0000000000000000000FOOD',
        name: 'All-purpose flour',
        description: null,
...
export function makeStatusResult(overrides: Partial<StatusResponse> = {}): StatusResponse {
    return {
        id: '01J0000000000000000000FOOD',
        status: FoodResolutionStatus.PENDING,
        ...overrides,
