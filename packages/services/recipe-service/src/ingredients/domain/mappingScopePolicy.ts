 ...
 *
 * ADR-0040: `principalKind` + `containment` are REQUIRED and passed straight through to the shared rule, which is
 * where containment is composed — this adapter adds no rule of its own about them.
 */
export interface MappingWriteInput extends ContainmentSubject {
