 ...
 * `StatusResponse`, in one place, as pure total functions.
 *
...
import type { FoodStatus, StatusResponse } from '@kitchensink/food-service-client';
 ...
 */
export function canonicalNameFrom(status: StatusResponse): CanonicalIngredientName | undefined {
