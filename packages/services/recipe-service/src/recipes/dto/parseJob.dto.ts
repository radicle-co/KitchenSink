/**
 * Request DTOs for the parse-job resource (plan U9).
 *
 * Thin `nestjs-zod` adapters over the AUTHORED contract in `../parseJobs.schema.ts` (CODING_STANDARDS
...
import { createParseJobRequestSchema, editParseJobLineRequestSchema } from '../parseJobs.schema.js';
