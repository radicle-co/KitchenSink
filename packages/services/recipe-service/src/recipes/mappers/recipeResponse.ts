 ...
 */
import type { LineResolutionStatus, RecipeDetailNutrition, RecipePhoto } from '@kitchensink/recipe-core';
...
export function toRecipeResponse(aggregate: RecipeAggregate, extras: RecipeResponseExtras = {}): RecipeResponse {
    ...
    // no nutrition fields is what "we did not look it up" honestly looks like; a pinned
    // `hasPartialNutrition: true` would claim "partial", a different fact.
