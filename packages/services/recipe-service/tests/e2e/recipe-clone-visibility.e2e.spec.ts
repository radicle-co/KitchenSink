 ...
 * `src/recipes/domain/visibility-policy.ts:97`):** a clone of a `user_created` (or `imported_public`)
 ...
 * `src/recipes/domain/recipe-visibility.ts`):** a source the caller cannot VIEW — private and not their
