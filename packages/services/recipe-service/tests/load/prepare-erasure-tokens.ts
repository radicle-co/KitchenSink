/**
 * Mint the EdDSA service-erasure tokens the k6 `service-erasure.load.js` scenario presents (CR-002 / U4a).
 *
 ...
 * exactly as `prepare-db.mjs` seeds the DB and `prepare-version-archive-fixture.ts` seeds S3 BEFORE the k6
 ...
 * mirroring `prepare-version-archive-fixture.ts`.
 *
