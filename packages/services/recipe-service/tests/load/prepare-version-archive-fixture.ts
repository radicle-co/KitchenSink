/**
 * Fixture prep for `version-archive-read.load.js` (W8-a.7).
 *
 ...
 *
 * `version-archive-read.load.js` addresses this fixture via the FIXED `ARCHIVE_FIXTURE_RECIPE_ID`
 ...
 *
 * Usage: `DATABASE_URL=postgres://... npx tsx tests/load/prepare-version-archive-fixture.ts`
...
/**
 * CLI entrypoint (`npx tsx tests/load/prepare-version-archive-fixture.ts`). Reads `DATABASE_URL` +
...
// Run when invoked directly (npx tsx tests/load/prepare-version-archive-fixture.ts), not when imported.
