...
//
// Fixture: run tests/load/prepare-version-archive-fixture.ts FIRST (via `npx tsx`, since k6 scripts can
...
//     packages/services/recipe-service/tests/load/version-archive-read.load.js
