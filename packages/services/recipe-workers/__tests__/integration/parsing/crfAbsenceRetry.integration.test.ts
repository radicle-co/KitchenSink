...
describe.skipIf(!canRun)('a residency-refused parse model never lands (integration)', () => {
     ...
     *
     * ⚠️ RETARGETED from `NOVA_2_LITE_MODEL_ID`, which the owner ruling of 2026-09-12 WARRANTED — so it is
     * residency-clear now and would exercise the opposite branch. Haiku 4.5 is deliberately left unwarranted
