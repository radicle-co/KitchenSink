...
describe('RecipeWorkersStack — RDS IAM auth + per-stage database', () => {
    ...
    it('points every Lambda at the PER-PR logical database, never the shared base one', () => {
        ...
        // reads that parameter. So the thing to assert is that all ten Lambdas read the parameter for THIS
        ...
        // trade: the old assertion could prove the ten agreed with EACH OTHER, never that they agreed with
