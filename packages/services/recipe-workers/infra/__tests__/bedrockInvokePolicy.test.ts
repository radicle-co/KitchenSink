...
describe('bedrockInvokeStatements', () => {
    ...
    it('names a region outside the deploy region ONLY for a profile that carries a warrant', () => {
        // ⛔ THE WARRANT'S BLAST RADIUS, asserted rather than assumed. Cross-region ARNs are exactly what the
        // refusal used to eliminate, so their return is the visible cost of the ruling — and it must be
