...
describe('the invocation id, and the identity it is not', () => {
    ...
    it('refuses ANY unwarranted model the SSM parameter names — it is the same table, judged the same way', async () => {
        ...
        //
        // ⚠️ RETARGETED, not weakened: this named Nova 2 Lite, which the owner ruling of 2026-09-12
        // WARRANTED — so it is now residency-clear and proves nothing here. Haiku 4.5 is deliberately left
