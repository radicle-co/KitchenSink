 ...
 * Nova Micro's 64%/30%) and now residency-WARRANTED (owner ruling 2026-09-12, ADR-0024 §4b).
 *
 ...
 * Nova Lite v1 it replaces (5.5× on input, 11.5× on output, 5.5× on cache reads), so the ADR-0024 pool
 * stretches less far. The accuracy it buys back is ~11 points on the ingredient half and ~12 on the
 * instruction half — the trade §9 originally made, now payable because residency no longer refuses it.
 *
