 ...
 *
 * ⛔ WHY A FIXTURE RATHER THAN A REAL MODEL. Naming whichever shipped entry happens to carry no
 * `residencyApproval` makes the coverage hostage to a product decision: the day the owner warrants that
 * model, the only proof the refusal works disappears — silently, and precisely when a warrant makes that
 * proof most valuable. A fixture cannot be warranted out
