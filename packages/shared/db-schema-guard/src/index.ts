...
export { DATABASE_ROLES, MIGRATION_LEDGER_TABLE, RDS_MASTER_USERNAME } from './roles/databaseRoles.js';
export type { DatabaseRoles, DatabaseService } from './roles/databaseRoles.js';
export { databaseAclStatements, privilegesAfterApply, privilegesBeforeApply } from './roles/privilegeStatements.js';
...
export { OWNERSHIP_AUDIT_MARKER, auditObjectOwners, auditServicePrivileges } from './roles/ownershipAudit.js';
