 ...
 * static-password escape hatch — is needed by every IAM-authenticated workload (identity, its webhooks, food,
 * recipe, recipe-workers; `docs/plans/2026-09-11-database-role-split.md`). It is one piece of knowledge — how a
 * workload in this repository opens an IAM-authenticated connection — so it lives once. Service names, database
 * names and role names are NOT known here: every caller passes its own.
 *
