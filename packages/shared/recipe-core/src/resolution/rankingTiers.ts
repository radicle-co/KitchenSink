 ...
 *
 * ⚠️ Plan U5's consumption prior FUSES with the base as a `max`, NOT as an additive term, for the measured
 * reason recorded beside {@link RAW_AFFINITY_BONUS}; both operands stay in `[0, 1]`, so the bound below holds.
 *
