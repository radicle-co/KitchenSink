...
const SYSTEM_PROMPT = [
    ...
    '{"verdict":"agree"|"disagree"|"abstain","certainty":"low"|"medium"|"high","reason":"<one short sentence>"}',
    '',
    '"agree" means the parse matches the line for every aspect you were asked about.',
    '"disagree" means at least one asked-about aspect does not match.',
