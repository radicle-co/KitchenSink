 ...
 * figure in `docs/reports/2026-08-23/ingredientParseModelComparison.md` is denominated in these
 ...
 *
 * It imports the subpath directly, never a local `parseComparison/parsePrompt.ts` re-export
 * (`CODING_STANDARDS §4`): such an alias buys nothing the subpath does not.
 */
