 ...
 */
import { consumableSlots, POOL_PASSWORD, slotFor } from '@kitchensink/e2e-fixtures/testPool';
...
export function deriveFixtureManifest(runKey: string): FixtureManifest {
    return Object.freeze({
        runKey,
        signInEmail: slotFor('maestro', 'signer').email,
        coAuthorEmail: slotFor('maestro', 'coauthor').email,
