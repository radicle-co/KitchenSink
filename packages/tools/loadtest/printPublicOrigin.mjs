 ...
 *
 * The shape is authored in `@radicle-co/infra-shared/alb` and COPIED to `./publicOriginHost.mjs`
 * (CDK installs outside the workspace; `publicOriginHostParity.test.ts` guards the copy)
 ...
 */
import { EPHEMERAL_SLOT_ORDER, publicServiceOriginForStage } from './publicOriginHost.mjs';
