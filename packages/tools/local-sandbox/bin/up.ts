 ...
 * `compose.yml` (LocalStack 3, `SERVICES: s3`) and `infra/localstack/compose.yml`
...
async function main(): Promise<void> {
    ...
    const siblings: Record<string, { hostPort: number; containerPort: number }> = Object.create(null) as Record<
        string,
