 ...
 * the code-quality toolchain's boundaries ratchet takes `--stdin`: the alternative is a test that must know the real
 * value in order to check that the real value is absent.
 */
