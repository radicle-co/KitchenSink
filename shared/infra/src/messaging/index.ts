/**
 * `@radicle-co/infra-shared/messaging` — the message substrate's INFRASTRUCTURE naming authority (plan U5/U6).
 *
 * Like `@radicle-co/infra-shared/alb` (and unlike most `@kitchensink/*` packages) this exports BUILT JS, not
