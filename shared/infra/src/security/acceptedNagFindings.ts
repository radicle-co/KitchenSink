    ...
    TASK_ENVIRONMENT_HOLDS_NO_SECRET: [
        {
            ...
            reason:
                ...
                'recipe_app/identity_service under RDS IAM auth), CloudFormation ImportValue/Ref of hostnames, bucket names, ARNs ' +
                ...
                'appears under Secrets, never Environment: AUTH_PUBLISHABLE_KEY, USDA_API_KEY; no task holds a ' +
                'database password at all. THE INVARIANT THIS SUPPRESSION DEPENDS ON: nothing secret ' +
