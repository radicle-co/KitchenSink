...
- [ ] T010 [P] Add recipe-service config module barrel and loader entrypoint in `packages/services/recipe-service/src/config/index.ts` and `packages/services/recipe-service/src/config/load-config.ts`
