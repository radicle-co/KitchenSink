...
**Created**: 2026-05-02
**Last Updated**: 2026-07-06 (reconciliation pass: realigned Target Source File paths to the canonical `packages/<category>/<name>` layout — recipe backend → `packages/services/recipes`, worker Lambdas → `packages/services/recipes-workers/src/{photo-processor,version-archive-worker}`; prior: 2026-05-08 PRF-UTP-001 remediation)
**Status**: Draft
...
**Target Source File(s)**: `packages/services/recipes/src/ingredients/ingredient.resolver.service.ts`
