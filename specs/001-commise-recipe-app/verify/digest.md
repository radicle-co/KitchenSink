...
- **Skipped:** authed E2E/Maestro _execution_ (Clerk dev sign-in down locally — pre-existing env limit; specs exist + CI-wired); the deterministic traceability pre-gate (validator is CommonJS, repo forces ESM + no `traceability.yml`).
