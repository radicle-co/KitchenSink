...
| ----------------- | ----------------------------------------------------------------------------------- | --------------------------------------- |
| Profile / account | [`screens/screenProfile.html`](../../../../docs/mockups/screens/screenProfile.html) | Reference for `T-053`, `T-063`          |
| Post-auth shell   | [`screens/screenAuth.html`](../../../../docs/mockups/screens/screenAuth.html)       | Authenticated landing / account context |
