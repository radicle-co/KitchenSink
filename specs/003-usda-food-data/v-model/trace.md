...
| HAZ-002 | Unauthenticated access to food data endpoints                                    | High     | REQ-035, REQ-IF-007 | All /v1/foods/\* endpoints protected by shared Clerk auth middleware (networkless verifyToken via CLERK_JWT_KEY + azp) | AT-035-A                        | ⬜     |
