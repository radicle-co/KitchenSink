...
> **all 62 requirements then in the set** (the set has since grown to 63) — the coverage claim was an
> assertion no tool could confirm. This revision uses the
...
`requirements.md` is baselined (63 requirements, owner decisions D-001..D-014 recorded). Implementation has
