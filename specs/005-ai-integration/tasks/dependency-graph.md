...
| T087 | M    | `AS/src/common/__tests__/api-route-paths.test.ts`                                                                                             | T001                                      | U-20 | 2    | yes                 | Decorator-metadata tier, no HTTP/DB. **Stays red until the last controller lands — it is an end-gate, not a wave-2 deliverable (F-10).**                     |
