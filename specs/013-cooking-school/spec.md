...
| FR-010 | Revenue share: platform 20%, educator 80% (pro tier: 15%/85% via 010). ⚠️ **Blocked on marketplace payments** — 010 has no payout or revenue-split surface (see 010's Out of Scope). This blocks educator **compensation** only; course **access control** gates on the learner's entitlement and needs just `010-FR-044`. | P13 Reese, P9 Drew  |
