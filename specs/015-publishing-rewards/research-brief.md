...
**Origin**: [`docs/competitive/02GapAnalysisAndStrategy.md`](../../docs/competitive/02GapAnalysisAndStrategy.md) §3 (P2) and the ReciMe teardown
...
- **D4a / D4b** (`docs/competitive/02GapAnalysisAndStrategy.md`) — un-gating privacy from the paywall and
