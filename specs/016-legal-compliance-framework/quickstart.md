...
⚠️ Maestro needs the **`mobile-e2e`** PR label and k6 the **`k6`** label, or they never run. Both also
require a live sandbox for this PR (ADR-0028) — press **Actions → Sandbox Up**. The full suite on demand
is **Actions → Deployed E2E** (ADR-0032).
