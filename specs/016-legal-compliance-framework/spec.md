...
be revoked. The corpus is a strategic asset (`docs/competitive/02GapAnalysisAndStrategy.md` §0); we license
_in_, not _out_.
...
- **D4a and D4b land** (`docs/competitive/02GapAnalysisAndStrategy.md`): free users may set their own
