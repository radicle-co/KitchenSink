...
- **FR-034a**: [NEEDS CLARIFICATION: `C-018-004` — **what is the commission, measured against the STACK
  ...
  ~$69–$399/month) take **0%** of revenue. Etsy's oft-quoted **25.7%** is an _effective_ rate across physical
...
- **FR-058h-i** — ⛔ **CORRECTION, and it overrides an earlier line in this section**: **per-recipe nutrition
  MUST NOT be a gate.** [`docs/competitive/02GapAnalysisAndStrategy.md`](../../docs/competitive/02GapAnalysisAndStrategy.md)
...
| `docs/competitive/02GapAnalysisAndStrategy.md`         | **D5** and **D23** are load-bearing inputs to `C-018-003c` and `C-018-004` and are cited here rather than restated. No amendment needed — recorded so the contradiction between D5's "more generous free tier" and the tightening instinct is resolved in one place, not twice.                                                                                                                                                                                                                                                                                                 | —             |
...
([`docs/competitive/02GapAnalysisAndStrategy.md`](../../docs/competitive/02GapAnalysisAndStrategy.md),
